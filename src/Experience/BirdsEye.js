...
export default class BirdsEye {
  ...
  setCameraPositionLakeFacade() {
    const cameraPosition = {
      x: 3083.4403115020214,
      y: 183.08829851055833,
      z: 1597.4163062514085,
    };
    // -7.437792976827618,  55.7431423000247,  -1.7641486363351758e-14
    const cameraRotation = {
      x: THREE.MathUtils.degToRad(-7.437792976827618),
      y: THREE.MathUtils.degToRad(55.7431423000247),
      z: THREE.MathUtils.degToRad(-1.7641486363351758e-14),
    };
  ...
  setCameraPositionStreet() {
    const cameraPosition = {
      x: 1834.6653186615072,
      y: 55.28989447079854,
      z: 1091.2480561173586,
    };
    // -6.291877386565971,  140.88467065646557,  -4.199775357469028e-14
    const cameraRotation = {
      x: THREE.MathUtils.degToRad(-6.291877386565971),
      y: THREE.MathUtils.degToRad(140.88467065646557),
      z: THREE.MathUtils.degToRad(-4.199775357469028e-14),
    };
    this.setCameraParameters(cameraPosition, cameraRotation);
  }
  ...
  setCameraPark() {
    const cameraPosition = {
      x: 165.1595479209716,
      y: 119.2755234039048,
      z: 1597.8762839711906,
    };
    // -3.312496851885768,  -82.17841630726844,  -5.993432096049718e-14
    const cameraRotation = {
      x: THREE.MathUtils.degToRad(-3.312496851885768),
      y: THREE.MathUtils.degToRad(-82.17841630726844),
      z: THREE.MathUtils.degToRad(-5.993432096049718e-14),
    };
    this.setCameraParameters(cameraPosition, cameraRotation);
  }
  ...
  addPlane() {
    ...
    //top of street plane - use case 2: query for 31% tree and 28% sky
    this.plane.position.set(
      1036.422684326128,
      74.82014184827656,
      1083.988372947677
    ...
    this.plane.scale.set(0.027724335239470474, 1, 1.6242933499781063);
