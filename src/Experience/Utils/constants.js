...
export const CAMERA_LOOKAT = [
  ...
  //     1378
  // ),
  new THREE.Vector3(500, 50, 1378),
  // new THREE.Vector3(
  //     733,
  //     55,
  //     714
  // ),
  new THREE.Vector3(733, 200, 714),
  new THREE.Vector3(172, 150, 387),
  // new THREE.Vector3(
  //     172,
  //     50,
  //     387
...
export const CAMERA_BUILDING_LOOKAT = [
  new THREE.Vector3(2973, 20, 1286),
  new THREE.Vector3(2477, 20, 2838),
  new THREE.Vector3(1900, 20, 2023),
  new THREE.Vector3(-4, 20, 1536),
  new THREE.Vector3(-119, 20, -82),
  new THREE.Vector3(382, 20, 912),
];
